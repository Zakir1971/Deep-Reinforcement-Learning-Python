...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 22 13:00:19 2020
...
class CRANParser(argparse.ArgumentParser):
    ...
    def __init_cran(self):
        ...
        self.add_argument('--num_usr', type=int, default=4, help='number of usr per cell')
        ...
        self.add_argument('--pow_gap', type=float, default=3.0, help='transition power for RRH Watts')
        self.add_argument('--pow_tsm', type=float, default=1.0, help='maximal transmit power for RRH Watts')
#        self.add_argument('--pow_on', type=float, default=10 *math.log10 ((10 **3)* (6.8)), help='active power for RRH dBm')#by zakir
#        self.add_argument('--pow_slp', type=float, default=10 *math.log10 ((10 **3)* (4.3)), help='sleep power for RRH dBm')#by zakir
#        self.add_argument('--pow_gap', type=float, default=10 *math.log10 ((10 **3)* (3.0)), help='transition power for RRH dBm')#by zakir
#        self.add_argument('--pow_tsm', type=float, default=10 *math.log10 ((10 **3)* (1.0)), help='maximal transmit power for RRH dBm')#by zakir
...
#        self.add_argument('--power_min', type=float, default=10 *math.log10 ((10 **3)* (10.0)), help='minimal per antenna power')#by zakir
#        self.add_argument('--power_max', type=float, default=10 *math.log10 ((10 **3)* (50.0)), help='maximal per antenna power')#by zakir
